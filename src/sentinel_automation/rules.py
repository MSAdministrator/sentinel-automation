...
class Rules(GraphConnector):
    ...
    URL = Template(
        "https://management.azure.com/subscriptions/$subscription_id/resourceGroups/$resource_group_name/providers/Microsoft.OperationalInsights/workspaces/$workspace_name/providers/Microsoft.SecurityInsights/automationRules?api-version=$api_version"
    )

    def list(self) -> List[Dict[str, str]]:
        """Lists out all automation rules in Sentinel workspace.

        Returns:
            List[Dict[str, str]]: A list of automation rules.
        """
        ...
        return self.invoke(method="GET", url=url)
